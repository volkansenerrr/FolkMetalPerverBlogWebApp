<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UyeResetPassword.aspx.cs" Inherits="FolkMetalPerverBlogWebApp.Uyeler.UyeResetPassword" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>Üye Şifre Sıfırlama</title>
    <link href="UyeCss/UyeResetPassword.css" rel="stylesheet" />
    <style>
...
<body>
    <form id="form1" runat="server">
        <div class="tasiyici">
            <h3 class="baslik">Üye Şifre Sıfırlama</h3>
            <div class="sol">
                <!-- Mail Girişi -->
                <div class="satir">
                ...
                <div class="satir">
                    <asp:Button ID="btn_UyeSifreSifirla" runat="server" OnClick="btn_UyeSifreSifirla_Click" Text="Şifreyi Sıfırla" CssClass="sifirlaButon" />
                </div>
